...
public class Versions {
    ...
    private Map<String, DreamWorld> generationVi;
    ...
    public Map<String, DreamWorld> getGenerationVi() { return generationVi; }
    public void setGenerationVi(Map<String, DreamWorld> value) { this.generationVi = value; }
